...
import com.google.android.gms.maps.model.MarkerOptions;
 public class Maps2Activity extends FragmentActivity implements OnMapReadyCallback,
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            String pos=intent.getStringExtra("Latlng");
            String[] geo = pos.split(",");
            String x[]=geo[0].split("\\(");
            String y[]=geo[1].split("\\)");
            double lati = Double.parseDouble(x[1]);
            double lngi = Double.parseDouble(y[0]);
            point= new LatLng(lati, lngi);
