...
public class MapsHotelActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.map_hotel);
...
runOnUiThread(new Runnable() {
    ...
    public void run() {
       // mMap.moveCamera(CameraUpdateFactory.newLatLng(origin));
        ...
        Intent i = new Intent(MapsHotelActivity.this, TinderMain.class);
        startActivity(i);
    }
});
        }
    ...
    public static List<Data> dataGetter(Context context){
        ...
        for(int i=0;i<nameList.size()&&i<photoList.size();i++)
        {
            Data data = new Data();
